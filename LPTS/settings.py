"""
Django settings for LPTS project.
...
SECRET_KEY = "django-insecure-(b8_!bq=j*0%-2hs*a(b42mhuo-75_i7s3u5$_55kt=l@#di4r"
...
WSGI_APPLICATION = "LPTS.wsgi.application"
