...
class WebPage(object):
    ...
    def check(self):
        ...
        file_path = os.path.join(BASE_DIR, 'database', 'apps.txt')
...
class Wappalyzer(object):
    ...
    def __init__(self, apps_file=None):
        ...
        """
        BASE_DIR = Path(__file__).resolve().parent.parent
        file_path = os.path.join(BASE_DIR, 'database', 'apps.json')
...
if __name__ == '__main__':
    print(getwhatcms('https://bba51f1b-33f4-46fd-a02f-8b1211ef71af.challenge.ctf.show/'))